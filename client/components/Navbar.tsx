...
<div className="flex items-center gap-3">
            <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#34d399] to-[#7c6cf0] shadow-[0_0_20px_rgba(52,211,153,0.3)]">
