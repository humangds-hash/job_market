...
export const CONTRACT_ADDRESS =
  "CCUFF7AOIPKQZNVH43ZZTZGWNGG2H5HDQVVIYWDSTSTGNGP43WVAR3HP";
...
// ============================================================
// Job Marketplace — Contract Methods
// ============================================================

/**
 * Post a new job listing.
 * Calls: post_job(employer: Address, id: u64, title: String, description: String)
 */
export async function postJob(
  ...
  return callContract(
    "post_job",
    [toScValAddress(caller), toScValU32(id), toScValString(title), toScValString(description)],
    caller,
    true
  );
}
 ...
 * Calls: close_job(employer: Address, id: u64)
 */
export async function closeJob(
  ...
  return callContract(
    "close_job",
    [toScValAddress(caller), toScValU32(id)],
    caller,
    true
  );
}
 ...
 * Returns: { id, employer, title, description, is_open } or null
 */
 ...
 * Calls: list_jobs() -> Vec<u64>
 */
export async function listJobs(caller?: string) {
  return readContract(
    "list_jobs",
    [],
    caller
